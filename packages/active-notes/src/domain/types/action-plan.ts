...
import type { ActiveNoteReviewSnapshot } from "./history.js";
...
export type ActiveNoteAnalysisSnapshotStatus =
  | "analyzing"
  | "review"
  | "applying"
  | "completed"
...
export interface ActiveNoteAnalysisSnapshot {
  sessionId: string;
  status: ActiveNoteAnalysisSnapshotStatus;
  content: string;
