...
export type { INoteRepository, INoteListItem } from "./note-repository.js";
...
export type { IPersonCollectionSortRepository } from "./person-collection-sort-repository.js";
export type {
  IPersonWork,
  IPersonWorkProjectEntry,
  IPersonWorkRepository,
  IPersonWorkTaskEntry,
} from "./person-work-repository.js";
