...
import { UpdateProjectCommand } from "../projects/update-project.command.js";
import { AddTaskToProjectCommand } from "../projects/add-task-to-project.command.js";
import { UpdateProjectChildCommand } from "../projects/project-child.commands.js";
import { DeleteProjectChildCommand } from "../projects/project-child.commands.js";
...
function createRepositories(overrides: Partial<{
  tasks: { getListItemForOrg: ReturnType<typeof vi.fn> };
  notes: { getListItemForOrg: ReturnType<typeof vi.fn> };
}> = {}) {
  return {
    tasks: {
      getListItemForOrg: vi.fn(),
      ...overrides.tasks,
    },
    notes: {
      getListItemForOrg: vi.fn(),
...
describe("collectPreMutationProjectIds", () => {
  it("loads the persisted project id before deleting a note", async () => {
    const repositories = createRepositories({
      notes: {
        getListItemForOrg: vi.fn().mockResolvedValue({
          note: {},
