...
import { ProjectActionContextService } from "../../action-planning/services/project-action-context.service.js";

describe("ProjectActionContextService", () => {
  it("loads and builds project action context for one project", async () => {
    const service = new ProjectActionContextService({
    ...
    const context = await service.getProjectActionContext("project-1");
